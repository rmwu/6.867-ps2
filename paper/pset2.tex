...
(as in Equation \ref{eq:2-2-gaussian-rbf}), given fixed $\lambda = 0.02$ and maximum number of epochs = 10000. We vary the bandwidth with $\gamma = \{2^{-2},\dots,2^2\}$, where $\gamma = \f{1}{2\sigma^2}$.
...
\begin{figure*}[t]
   ...
   \caption{Larger $\gamma$ increases the fit to data. On the test sets, classification errors were 28/200, 14/200, and 11/200, respectively.}
   \label{fig:3-3-gamma}
\end{figure*}
